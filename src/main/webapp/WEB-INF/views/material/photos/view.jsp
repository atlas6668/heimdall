...
<body>
	...
	<spring:url value="/material/photos/upload" var="load" />
	<form:form action="${load}" modelAttribute="model" method="post"
		onsubmit="return checkFrm(this)" class="form-horizontal" enctype="multipart/form-data">
			<div class="control-group">
		    	<div class="controls">
					<div id="preview">
					    <img id="imghead" class="img-polaroid" src="<spring:url value='/resources/images/no_image.jpg'/>">
					</div>
