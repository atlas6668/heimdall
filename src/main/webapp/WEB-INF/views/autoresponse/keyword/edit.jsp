...
<body>
	...
	<div class="comment">
        <div class="com_form">
			<spring:url value="/autoresponse/keyword/save" var="save" />
			<form:form id="s_form" action="${save}" modelAttribute="model" method="post" 
				enctype="multipart/form-data">
			    <form:hidden path="id"/>
			    <form:hidden path="content"/>
			    <form:hidden path="messageType" value="text"/>
			    <label class="control-label">规则名称:</label><form:input path="ruleName" class="input-xxlarge"/>
			    <label class="control-label">关键词:</label><form:input path="keyword" class="input-xxlarge"/>
			</form:form>
        	...
        	<div class="btn-toolbar">
				<div class="btn-group">
					...
					<button class="btn disabled">图文</button>
			    </div>
		    </div>
        	<hr>
	...
	<div class="comment1">
		<div class="com_form">
		    <input id="saveBut" type="button" class="btn btn-primary" value="保存" >
		    <input id="clearBut" type="button" class="btn btn-warning" value="清空" >
		</div>
	</div>
